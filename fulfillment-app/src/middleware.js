...
export function middleware(req) {
  ...
  console.log(`📦 Fulfillment Zone - Middleware triggered for: ${pathname}`);
  ...
  if (!authenticated) {
    console.log(`🔒 Fulfillment Zone - Access denied to ${pathname} - redirecting to login`);
  ...
  console.log(`✅ Fulfillment Zone - Access granted to ${pathname} - user authenticated`);
  return NextResponse.next();
}
